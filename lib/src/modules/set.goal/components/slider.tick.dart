...
class LineSliderTickMarkShape extends SliderTickMarkShape {
  ...
  void paint(
    ...
    final Paint paint = Paint()..color = ColorTween(begin: begin, end: end).evaluate(enableAnimation)!..strokeWidth = 2.0;
    ...
    if (tickMarkRadius > 0) {
      context.canvas.drawLine(Offset(center.dx , center.dy - 5), Offset(center.dx, center.dy + 5), paint);
    }
  }
}